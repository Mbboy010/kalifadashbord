...
const ContractMessagesComponent: React.FC = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8 border-t border-dashed border-red-500">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-red-500 mb-6 text-center">Contact Messages</h2>
        ...
        <div className="space-y-4">
          {loading
            ? Array.from({ length: 5 }).map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse p-4 bg-gray-800/40 backdrop-blur-md rounded-lg shadow-md"
                >
